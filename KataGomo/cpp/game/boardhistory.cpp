...
float BoardHistory::getApproxScore(const Board& board) const {
  return GameLogic::getApproxScore(board);
}

float BoardHistory::getStaticScore(const Board& board) const {
  return GameLogic::getApproxScore(board);
}
