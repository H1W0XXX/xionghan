...
static constexpr Color C_BLACK = 1; // Generic black (for legacy)
static constexpr Color C_WHITE = 2; // Generic white (for legacy)
static constexpr Color C_WALL  = 3; // Wall / Great Wall

// Piece Types for Xionghan Xiangqi
static constexpr Color PT_NONE     = 0;
static constexpr Color PT_ROOK     = 1;  // 车
static constexpr Color PT_KNIGHT   = 2;  // 马
static constexpr Color PT_CANNON   = 3;  // 炮
static constexpr Color PT_ELEPHANT = 4;  // 相/象
static constexpr Color PT_ADVISOR  = 5;  // 士/仕
static constexpr Color PT_KING     = 6;  // 王/帅
static constexpr Color PT_PAWN     = 7;  // 卒/兵
static constexpr Color PT_LEI      = 8;  // 檑
static constexpr Color PT_FENG     = 9;  // 锋
static constexpr Color PT_WEI      = 10; // 卫

static constexpr int NUM_BOARD_COLORS = 48; // (Player(2)<<4) | PieceType(11) -> max 42ish
...
static inline Color makePiece(Player p, Color pt) {
  return (p << 4) | pt;
}
